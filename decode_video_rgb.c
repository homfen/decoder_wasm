...
typedef void(*VideoCallback)(unsigned char* data_y, unsigned char* data_u, unsigned char* data_v, int line1, int line2, int line3, int width, int height, long pts, unsigned char* bgr, int frameSize);
...
static ErrorCode decodeBgr(AVCodecContext* dec_ctx, AVFrame* frame, AVPacket* pkt)
{
